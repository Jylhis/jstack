...
describe("jstack-global-discover", () => {
  describe("normalizeRemoteUrl", () => {
    ...
    test("SSH and HTTPS for same repo normalize to same URL", () => {
      const ssh = normalizeRemoteUrl("git@github.com:Jylhis/jstack.git");
      const https = normalizeRemoteUrl("https://github.com/Jylhis/jstack.git");
      const httpsNoDotGit = normalizeRemoteUrl("https://github.com/Jylhis/jstack");
