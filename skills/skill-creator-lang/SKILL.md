...
6. **Research.** Delegate research to the `research` skill, the `Explore` subagent,
   web search, and Context7 docs tools. Hand it a concrete brief listing every topic
   in step 7. Ask for:
