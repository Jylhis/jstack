...
3. **Contributor mode** — reads `jstack_contributor` from config. When true, the agent files casual field reports to `~/.jstack/contributor-logs/` when jstack itself misbehaves.
